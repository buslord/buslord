...
func prefetchStops() {
	...
	neLat := 52.06584022059412
	neLng := -0.01008761816410697
	swLat := 51.52994371627174
	swLng := -0.997483858398482
	/*
		neLat := 51.780743516609355
		neLng := -0.031545290283247596
		swLat := 51.43875941494288
		swLng := -0.5252434104004351
	*/
	/*
